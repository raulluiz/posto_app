...
class NovoChamadoTecnicoScreen extends StatefulWidget {
  @override
  _NovoChamadoTecnicoScreenState createState() => _NovoChamadoTecnicoScreenState();
}

class _NovoChamadoTecnicoScreenState extends State<NovoChamadoTecnicoScreen> {
