...
class NovaPreventivaTecnicoScreen extends StatefulWidget {
  @override
  _NovaPreventivaTecnicoScreenState createState() => _NovaPreventivaTecnicoScreenState();
}

class _NovaPreventivaTecnicoScreenState extends State<NovaPreventivaTecnicoScreen> {
